  ...
  for (int i = 0; i < spheres.size(); ++i)
  {
    for (int j = 0; j < spheres[i].size(); ++j)
    {
      ...
      if (j < spheres[i].size() -1)
        springs.push_back(new Spring(spheres[i][j], spheres[i][j + 1], sphereDistance, 2000));
      
      if (i < spheres.size() - 1)
        springs.push_back(new Spring(spheres[i][j], spheres[i + 1][j], sphereDistance, 2000));
    }
  }
}
...
void Scene::Scene2()
{
  ...
  springs.push_back(new Spring(spheres[0][0], spheres[0][1], 0.05, 400.0));
  ...
  springs.push_back(new Spring(spheres[1][0], spheres[1][1], 0.05, 4000.0));
  ...
  springs.push_back(new Spring(spheres[2][0], spheres[2][1], 0.05, 200));
  ...
  springs.push_back(new Spring(spheres[3][0], spheres[3][1], 0.05, 200));
